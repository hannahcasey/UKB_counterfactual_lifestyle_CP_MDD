...
single_disorder_table$Exposure[single_disorder_table$Exposure == "too_little_sleep"] <- "insufficient sleep" 
single_disorder_table$Exposure[single_disorder_table$Exposure == "too_much_sleep"] <- "excessive sleep" 
...
comorbidity_table$Exposure[comorbidity_table$Exposure == "too_little_sleep"] <- "insufficient sleep" 
comorbidity_table$Exposure[comorbidity_table$Exposure == "too_much_sleep"] <- "excessive sleep" 
...
table_counter <- table_counter + 1
```
Table S`r table_counter` Full results for association between lifestyle-related variables and nominla comorbidity groups in full, female and male sample. \*, \*\* and \*\*\* represent significant results at p~FDR~\<.05, p~FDR~\<.01 and p~FDR~\<.001, respectively. Significant results are highlighted in bold. 
